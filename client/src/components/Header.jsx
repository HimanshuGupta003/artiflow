...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            >Unleash your creativity with AI. Turn your imagination into visual art in seconds - just type, and watch the maggic happen.</p>
            ...
            <motion.div className='flex flex-wrap justify-center mt-11 gap-3'
            initial={{opacity:0}}
            animate={{opacity:1}    }
            ...
            >Generated images from ArtiFlow</motion.p>
